...
<template>
  <VDialog :width="$vuetify.display.smAndDown ? 'auto' : 650" :model-value="props.isEditOpen" @update:model-value="dialogModelValueUpdate">
    <!-- Dialog close btn -->
    ...
    <VCard class="pa-sm-9 pa-5">
      ...
      <VCardText>
        ...
        <VForm ref="refForm" @submit.prevent="onFormSubmit">
          <VRow>
            <VCol cols="12">
              <VSelect v-model="itemData.order_state_id" :items="orderStatuses" :label="t('forms.order_state')" item-title="customer_state_ar" item-value="code" :rules="[requiredValidator]" />
            </VCol>
