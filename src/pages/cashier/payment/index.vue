<template>
  <div>
    ...
    <VRow>
      <VCol :cols="cashierStore.cart.length > 0 ? 8 : 12">
    ...
    >
      <template #content>
        <VCardTitle class="text-h5 d-flex flex-column align-center gap-1 text-center mb-3">
          <span>
...
const totalPrice = () => {
  return Object.values(paymentInfo.prices).reduce((total, value) => total + Number(value), 0)
}
